...
import { NewAreaSheet } from "@/features/areas/components/new-area-sheet"
import { EditAreaSheet } from "@/features/areas/components/edit-area-sheet"
...
export default function AreasPage() {
  ...
  const { data, isLoading, isFetching } = useGetAreas({
    page,
    pageSize,
    nombre: search || undefined,
  })
  const { open } = useNewArea()
    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground">
          <span>{data?.total ?? 0} áreas en total</span>
          {totalPages > 1 && (
